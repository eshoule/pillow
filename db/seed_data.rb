...
PHOTOS = {
  outside: [
    ...
    aws_path + "outside/pexels-photo-210017.jpeg ",
  ...
  bed: [
    aws_path + "bed/pexels-photo-1103808.jpg",
    aws_path + "bed/pexels-photo-1267438.jpg",
    aws_path + "bed/pexels-photo-1329711.jpg",
    aws_path + "bed/pexels-photo-1374125.jpg",
    aws_path + "bed/pexels-photo-210265.jpg",
    aws_path + "bed/pexels-photo-237371.jpg",
    aws_path + "bed/pexels-photo-260553.jpg",
    aws_path + "bed/pexels-photo-775219.jpg",
    aws_path + "bed/pexels-photo-90317.jpg",
    aws_path + "bed/pexels-photo-916337.jpg",
  ],
  bath: [
    aws_path + "bath/pexels-photo-105934.jpg",
    aws_path + "bath/pexels-photo-1370763.jpg",
    aws_path + "bath/pexels-photo-1454804jpg",
    aws_path + "bath/pexels-photo-1457847.jpg",
    aws_path + "bath/pexels-photo-1504020.jpg",
    aws_path + "bath/pexels-photo-1571462.jpg",
    aws_path + "bath/pexels-photo-280209.jpg",
    aws_path + "bath/pexels-photo-342800.jpg",
    aws_path + "bath/pexels-photo-358592.jpg",
  ],
  structure: [
    aws_path + "structure/dublin-famous-colorful-doors-422844.jpeg",
    aws_path + "structure/pexels-photo-1010657.jpg",
    aws_path + "structure/pexels-photo-1115804.jpg",
    aws_path + "structure/pexels-photo-1123982.jpg",
    aws_path + "structure/pexels-photo-1862402.jpg",
    aws_path + "structure/pexels-photo-208560.jpg",
    aws_path + "structure/pexels-photo-210538.jpg",
    aws_path + "structure/pexels-photo-227675.jpg",
    aws_path + "structure/pexels-photo-235648.jpg",
    aws_path + "structure/pexels-photo-256150.jpg",
    aws_path + "structure/pexels-photo-277559.jpg",
    aws_path + "structure/pexels-photo-312997.jpg",
    aws_path + "structure/pexels-photo-323776.jpg",
    aws_path + "structure/pexels-photo-325185.jpg",
    aws_path + "structure/pexels-photo-358499.jpg",
    aws_path + "structure/pexels-photo-358574.jpg",
    aws_path + "structure/pexels-photo-462205.jpg",
    aws_path + "structure/pexels-photo-463734.jpg",
    aws_path + "structure/pexels-photo-534182.jpg",
    aws_path + "structure/pexels-photo-534247.jpg",
    aws_path + "structure/pexels-photo-731082.jpg",
    aws_path + "structure/pexels-photo-789380.jpg",
  ],
  inside: [
    aws_path + "inside/living-room-couch-interior-room-584399.jpeg",
    aws_path + "inside/pexels-photo-1080696.jpg",
    aws_path + "inside/pexels-photo-1834712.jpg",
    aws_path + "inside/pexels-photo-257344.jpg",
    aws_path + "inside/pexels-photo-259962.jpg",
    aws_path + "inside/pexels-photo-265004.jpg",
    aws_path + "inside/pexels-photo-271795.jpg",
    aws_path + "inside/pexels-photo-271816.jpg",
    aws_path + "inside/pexels-photo-275484.jpg",
    aws_path + "inside/pexels-photo-276663.jpg",
    aws_path + "inside/pexels-photo-276724.jpg",
    aws_path + "inside/pexels-photo-279607.jpg",
    aws_path + "inside/pexels-photo-279719.jpg",
    aws_path + "inside/pexels-photo-509922.jpg",
    aws_path + "inside/pexels-photo-534172.jpg",
    aws_path + "inside/pexels-photo-667838.jpg",
    aws_path + "inside/pexels-photo-706137.jpg",
  ],
  kitchen: [
    aws_path + "kitchen/kitchen-stove-sink-kitchen-counter-349749.jpeg",
    aws_path + "kitchen/pexels-photo-1358900.jpg",
    aws_path + "kitchen/pexels-photo-1454805.jpg",
    aws_path + "kitchen/pexels-photo-1663263.jpg",
    aws_path + "kitchen/pexels-photo-1757313.jpg",
    aws_path + "kitchen/pexels-photo-1757321.jpg",
    aws_path + "kitchen/pexels-photo-1884236.jpg",
    aws_path + "kitchen/pexels-photo-259819.jpg",
    aws_path + "kitchen/pexels-photo-271647.jpg",
    aws_path + "kitchen/pexels-photo-279648.jpg",
  ]
}