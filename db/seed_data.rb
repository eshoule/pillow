...
aws_path = "https://s3-us-west-1.amazonaws.com/pillow-app/"

PHOTOS = {
  outside: [
    aws_path + "outside/pexels-photo-1141853.jpeg",
    aws_path + "outside/pexels-photo-139780.jpeg",
    aws_path + "outside/pexels-photo-1732414.jpeg",
    aws_path + "outside/pexels-photo-1915705.jpeg",
    aws_path + "outside/pexels-photo-221455.jpeg",
    aws_path + "outside/pexels-photo-242258.jpeg",
    aws_path + "outside/pexels-photo-279614.jpeg",
    aws_path + "outside/pexels-photo-802970.jpeg",
  ],
  bed: [
    aws_path + "bed/pexels-photo-1103808.jpeg",
    aws_path + "bed/pexels-photo-1267438.jpeg",
    aws_path + "bed/pexels-photo-1329711.jpeg",
    aws_path + "bed/pexels-photo-1374125.jpeg",
    aws_path + "bed/pexels-photo-210265.jpeg",
    aws_path + "bed/pexels-photo-237371.jpeg",
    aws_path + "bed/pexels-photo-260553.jpeg",
    aws_path + "bed/pexels-photo-775219.jpeg",
    aws_path + "bed/pexels-photo-90317.jpeg",
    aws_path + "bed/pexels-photo-916337.jpeg",
  ],
  bath: [
    aws_path + "bath/pexels-photo-105934.jpeg",
    aws_path + "bath/pexels-photo-1370763.jpeg",
    aws_path + "bath/pexels-photo-1454804.jpeg",
    aws_path + "bath/pexels-photo-1457847.jpeg",
    aws_path + "bath/pexels-photo-1504020.jpeg",
    aws_path + "bath/pexels-photo-1571462.jpeg",
    aws_path + "bath/pexels-photo-280209.jpeg",
    aws_path + "bath/pexels-photo-342800.jpeg",
    aws_path + "bath/pexels-photo-358592.jpeg",
  ],
  structure: [
    aws_path + "structure/dublin-famous-colorful-doors-422844.jpeg",
    aws_path + "structure/pexels-photo-1010657.jpeg",
    aws_path + "structure/pexels-photo-1115804.jpeg",
    aws_path + "structure/pexels-photo-1123982.jpeg",
    aws_path + "structure/pexels-photo-1862402.jpeg",
    aws_path + "structure/pexels-photo-208560.jpeg",
    aws_path + "structure/pexels-photo-210538.jpeg",
    aws_path + "structure/pexels-photo-227675.jpeg",
    aws_path + "structure/pexels-photo-235648.jpeg",
    aws_path + "structure/pexels-photo-256150.jpeg",
    aws_path + "structure/pexels-photo-277559.jpeg",
    aws_path + "structure/pexels-photo-312997.jpeg",
    aws_path + "structure/pexels-photo-323776.jpeg",
    aws_path + "structure/pexels-photo-325185.jpeg",
    aws_path + "structure/pexels-photo-358499.jpeg",
    aws_path + "structure/pexels-photo-358574.jpeg",
    aws_path + "structure/pexels-photo-462205.jpeg",
    aws_path + "structure/pexels-photo-463734.jpeg",
    aws_path + "structure/pexels-photo-534182.jpeg",
    aws_path + "structure/pexels-photo-534247.jpeg",
    aws_path + "structure/pexels-photo-731082.jpeg",
    aws_path + "structure/pexels-photo-789380.jpeg",
  ],
  inside: [
    aws_path + "inside/living-room-couch-interior-room-584399.jpeg",
    aws_path + "inside/pexels-photo-1080696.jpeg",
    aws_path + "inside/pexels-photo-1834712.jpeg",
    aws_path + "inside/pexels-photo-257344.jpeg",
    aws_path + "inside/pexels-photo-259962.jpeg",
    aws_path + "inside/pexels-photo-265004.jpeg",
    aws_path + "inside/pexels-photo-271795.jpeg",
    aws_path + "inside/pexels-photo-271816.jpeg",
    aws_path + "inside/pexels-photo-275484.jpeg",
    aws_path + "inside/pexels-photo-276663.jpeg",
    aws_path + "inside/pexels-photo-276724.jpeg",
    aws_path + "inside/pexels-photo-279607.jpeg",
    aws_path + "inside/pexels-photo-279719.jpeg",
    aws_path + "inside/pexels-photo-509922.jpeg",
    aws_path + "inside/pexels-photo-534172.jpeg",
    aws_path + "inside/pexels-photo-667838.jpeg",
    aws_path + "inside/pexels-photo-706137.jpeg",
  ],
  kitchen: [
    aws_path + "kitchen/kitchen-stove-sink-kitchen-counter-349749.jpeg",
    aws_path + "kitchen/pexels-photo-1358900.jpeg",
    aws_path + "kitchen/pexels-photo-1454805.jpeg",
    aws_path + "kitchen/pexels-photo-1663263.jpeg",
    aws_path + "kitchen/pexels-photo-1757313.jpeg",
    aws_path + "kitchen/pexels-photo-1757321.jpeg",
    aws_path + "kitchen/pexels-photo-1884236.jpeg",
    aws_path + "kitchen/pexels-photo-259819.jpeg",
    aws_path + "kitchen/pexels-photo-271647.jpeg",
    aws_path + "kitchen/pexels-photo-279648.jpeg",
  ]
}